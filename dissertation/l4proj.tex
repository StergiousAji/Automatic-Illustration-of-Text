...
\begin{enumerate}[resume]
    ...
    \item \label{req:25} \textbf{Should Have:} The application being able to transcribe any audio source with phrase-level timestamps.
...
\begin{align*}
    ...
    &=
    \begin{bmatrix}
        \sum_{j=1}^N t_ji_{1j} & \sum_{j=1}^N t_ji_{2j} & \cdots & \sum_{j=1}^N t_ji_{Mj}
    \end{bmatrix}
